...
public class Main {
  public static void main(String[] args) {
    ...
    player4.setPlayerName("Luka Modric");
    player4.playerDetails("La Liga");
    player4.playerDetails("La Liga", "Real Madrid");
    player4.playerDetails("La Liga", "Real Madrid", "Mid fielder");
  }
}